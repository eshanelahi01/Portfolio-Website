...
export const expertiseAreas = [
  {
    ...
    description:
      'I build end-to-end products that connect polished React interfaces with dependable backend logic, database workflows, authentication, and production-ready deployment.',
    tags: ['React Developer', 'Full Stack Developer', 'MERN Stack Developer', 'Responsive UI'],
  },
  {
    index: '02',
    title: 'Backend APIs and System Logic',
    description:
      'I design backend services with Node.js, Express.js, Python, and FastAPI for clean REST APIs, integrations, data handling, route logic, and scalable product foundations.',
    tags: ['Backend Developer', 'API Developer', 'Node.js Developer', 'FastAPI Developer'],
  },
  {
    index: '03',
    title: 'AI Automation, Agents, and Chatbot Workflows',
    description:
      'I integrate AI features where they add practical value, including automation flows, RAG-style retrieval, chatbot experiences, AI agents, and workflow assistance inside web products.',
    tags: ['AI Automation Developer', 'AI Engineer', 'AI Agent Developer', 'RAG Developer'],
  },
  {
    index: '04',
...
export const serviceOffers = [
  {
    index: '01',
    title: 'React and MERN Web App Development',
    description:
      'Build customer-facing products, dashboards, admin portals, and internal tools with strong frontend structure and reliable backend delivery.',
    tags: ['React.js', 'Node.js', 'Express.js', 'MongoDB', 'JavaScript'],
  },
  {
    index: '02',
    title: 'Backend API Development and Integrations',
    description:
      'Create REST APIs, backend services, authentication flows, database-connected endpoints, and integration layers with Node.js, Python, and FastAPI.',
    tags: ['Backend APIs', 'REST APIs', 'FastAPI', 'Node.js', 'API Integrations'],
  },
  {
    index: '03',
    title: 'AI Automation, RAG, and AI Agent Workflows',
    description:
      'Add AI-powered product features such as chatbots, AI assistant flows, retrieval-based experiences, automation pipelines, and business workflow support.',
    tags: ['AI Automation', 'AI Agents', 'RAG Workflows', 'Chatbots', 'LLM Integration'],
  },
  {
    index: '04',
    title: 'Business Websites and Product Positioning',
    description:
      'Design and build modern websites that explain services clearly, support discovery, and make it easier for potential clients or teams to take the next step.',
    tags: ['Business Websites', 'Responsive Design', 'Technical SEO', 'Conversion UX'],
  },
]
...
export const whyWorkWithMe = [
  {
    ...
    description:
      'I focus on useful delivery, not just implementation. That means clear information architecture, practical interfaces, stable systems, and business-aware decisions.',
    tags: ['User-Focused', 'Business Aware', 'Clear Structure'],
  },
  {
    index: '02',
    title: 'Frontend to Backend Ownership',
    description:
      'I am comfortable moving across UI, APIs, data flow, and AI integrations, which helps keep the product consistent from first interaction to backend behavior.',
    tags: ['React', 'Node.js', 'MongoDB', 'Python', 'FastAPI'],
  },
  {
    index: '03',
    title: 'Practical AI Integration',
    description:
      'I treat AI as a product capability, not decoration. The goal is to make workflows faster, interactions smarter, and systems more useful for real users.',
    tags: ['Automation', 'AI Agents', 'Chatbots', 'RAG'],
  },
  {
    index: '04',
    title: 'Clear Communication and Clean Delivery',
    description:
      'I value understandable code, credible copy, and straightforward collaboration so teams and clients can move from idea to shipped work with less friction.',
    tags: ['Readable Code', 'Reliable Delivery', 'Recruiter Friendly'],
  },
]
...
export const projects = [
  ...
  },
  {
    slug: 'safarbot',
    name: 'SafarBot',
    title: 'SafarBot AI Travel Booking Platform',
    category: 'AI Travel Booking Platform',
    summary:
      'A full-stack travel booking platform that combines voice and text booking flows, bilingual Urdu and English interaction, route management, and AI-assisted travel support.',
    teaser:
      'Built as a serious AI-integrated product with React, Express.js, FastAPI, MongoDB, and automation-friendly workflows for booking, guidance, and smarter customer interaction.',
    problem:
      'Travel booking workflows can become slow, fragmented, and difficult to navigate when users need quick route guidance, bilingual interaction, and help moving through booking steps with confidence.',
    solution:
      'I built a full-stack platform that connects a responsive frontend, Express backend logic, a FastAPI AI service, and MongoDB-backed workflow data to support voice and text booking, bilingual interaction, and smoother travel guidance.',
    role:
      'Full-stack development, backend API architecture, AI service integration, and booking flow implementation.',
    stack: ['React.js', 'Node.js', 'Express.js', 'Python', 'FastAPI', 'MongoDB', 'REST APIs'],
    features: [
      'Voice and text booking interaction',
      'Bilingual Urdu and English booking support',
      'Route and booking flow management',
      'FastAPI-powered AI service integration',
      'Fraud-aware workflow support',
      'Real-time travel assistance patterns',
    ],
    outcomes: [
      'Created a smoother digital booking journey for users who need faster support and clearer booking guidance.',
      'Combined frontend, backend, and AI layers in a way that keeps the product extensible for future travel workflows.',
      'Showcased practical AI integration inside a business-facing web application rather than as a standalone demo.',
    ],
    proof: ['Full Stack Role', 'Voice + Text Booking', 'Urdu and English UX'],
    image: '/images/safarbot.png',
    imageAlt: 'SafarBot travel booking platform interface showing AI-assisted booking flows.',
    liveUrl: 'https://safar-bot.vercel.app',
    caseStudy: true,
    featured: true,
    socialImage: '/images/safarbot.png',
    keywords: [
      'AI travel booking platform',
      'full stack developer case study',
      'voice booking web app',
      'FastAPI AI integration',
      'MERN and Python project',
    ],
  },
  {
    slug: 'onyx-closings',
    name: 'Onyx Closings',
    title: 'Onyx Closings Website',
    category: 'Business Website',
    summary:
      'A polished business website focused on trust, clear messaging, and a strong client-facing experience for a service-oriented brand.',
    teaser:
      'Built to present services clearly, feel credible on first visit, and support smooth browsing across desktop and mobile screens.',
    problem:
      'The brand needed a clear, professional web presence that could communicate services quickly, build trust, and give potential clients an easier path to understand the business.',
    solution:
      'I developed a premium, responsive site structure with stronger content hierarchy, clear service presentation, and a smoother browsing experience for prospective clients.',
    role: 'Frontend development, responsive implementation, and service-led content structure.',
    stack: ['React.js', 'JavaScript', 'Responsive UI', 'Frontend Development', 'Technical SEO'],
    features: [
      'Clear service presentation',
      'Premium business-facing visual treatment',
      'Responsive layout across key breakpoints',
      'Stronger CTA flow and trust-oriented page structure',
    ],
    outcomes: [
      'Improved how the business presents itself online with clearer messaging and stronger first-impression credibility.',
      'Made the experience easier to scan and more comfortable to use across devices.',
      'Created a cleaner path for visitors to understand the offer and take the next step.',
    ],
    proof: ['Business Website', 'Frontend Role', 'Trust-Focused Messaging'],
    image: '/images/onyx.jpeg',
    imageAlt: 'Onyx Closings website interface with premium service-focused layout.',
    liveUrl: 'https://onyx-closings.vercel.app',
    caseStudy: true,
    featured: true,
    socialImage: '/images/onyx.jpeg',
    keywords: [
  ...
  {
    slug: 'abdanix-solutions',
    name: 'ABDANIX Solutions',
    title: 'ABDANIX Solutions Website',
    category: 'Company Website',
    summary:
      'A company website built to communicate services more clearly, strengthen credibility, and give the business a more modern digital presence.',
    teaser:
      'Designed and developed to help the company explain its services, look more established online, and provide a cleaner responsive experience.',
    problem:
      'The company needed a website that could explain its services clearly, feel modern, and support a stronger online presence for potential clients and partners.',
    solution:
      'I built a responsive company website with improved structure, clearer service communication, and a more credible presentation aligned with business goals.',
    role: 'Website development, responsive frontend implementation, and content architecture support.',
    stack: ['React.js', 'JavaScript', 'Responsive Design', 'Frontend Development', 'Content Structure'],
    features: [
      'Service-oriented information architecture',
      'Responsive layout and consistent presentation',
      'Clearer content hierarchy for business services',
      'Modern visual polish without sacrificing usability',
    ],
    outcomes: [
      'Strengthened how the company presents its services online.',
      'Made the site easier to browse and easier to understand for potential clients.',
      'Delivered a more modern and credible digital presence for the business.',
    ],
    proof: ['Company Website', 'Responsive Delivery', 'Service Clarity'],
    image: '/images/abdanix.jpeg',
    imageAlt: 'ABDANIX Solutions company website showing a modern service-focused homepage.',
    liveUrl: 'https://www.abdanixsolutions.com',
    caseStudy: true,
    featured: true,
    socialImage: '/images/abdanix.jpeg',
    keywords: [
      'company website case study',
      'frontend developer business site project',
      'service website development',
    ],
  },
  {
    slug: 'skylink-mobile-shop',
    name: 'Skylink Mobile Shop',
    title: 'Skylink Mobile Shop Website',
    category: 'Responsive Storefront Website',
    summary:
      'A responsive storefront-style website created to present products clearly and support a smoother browsing experience for customers.',
    teaser:
      'Built as a clean e-commerce style frontend with responsive layout, better product visibility, and a straightforward customer browsing flow.',
    problem:
      'The site needed a clearer storefront experience so products could be presented in a more organized and user-friendly way.',
    solution:
      'I built a responsive storefront layout that made product browsing more structured, more visual, and easier to navigate on different screen sizes.',
    role: 'Frontend development and responsive storefront implementation.',
    stack: ['React.js', 'JavaScript', 'Responsive UI', 'Frontend Development'],
    features: [
      'Responsive storefront layout',
      'Cleaner product visibility',
      'Mobile-friendly browsing experience',
      'Straightforward customer-facing navigation',
    ],
    outcomes: [
      'Made the product browsing experience cleaner and easier for visitors.',
      'Presented products in a more organized storefront format.',
    ],
    proof: ['Responsive Frontend', 'Storefront UX', 'Product Presentation'],
    image: '/images/skylink.jpeg',
    imageAlt: 'Skylink Mobile Shop website showing a product storefront layout.',
    liveUrl: 'https://skylinkmobileshop.netlify.app/',
    caseStudy: true,
    featured: false,
    socialImage: '/images/skylink.jpeg',
    keywords: ['responsive storefront website', 'frontend ecommerce style project'],
  },
]
